...
| NEXT_PUBLIC_CARDANO_ENTRYPOINT_RPC_ENDPOINT     | RPC end-point of Cardano Entrypoint chain                                                                                                       | Default: http://localhost:26657                                          |
| NEXT_PUBLIC_CARDANO_ENTRYPOINT_REST_ENDPOINT    | Rest end-point of Cardano Entrypoint chain                                                                                                      | Default: http://localhost:1317                                           |
