...
This Cosmos SDK chain is used as a dedicated packet-forwarding chain between Cardano and other Cosmos chains. In this repo it lives in `cosmos/entrypoint/`, and the binary is named `entrypointd`.
