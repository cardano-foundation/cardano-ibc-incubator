...
func (im IBCModule) OnRecvPacket(
	...
	var modulePacketData types.VesseloraclePacketData
	...
	case *types.VesseloraclePacketData_ConsolidatedDataReportPacketPacket:
		packetAck, err := im.keeper.OnRecvConsolidatedDataReportPacketPacket(ctx, modulePacket, *packet.ConsolidatedDataReportPacketPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeConsolidatedDataReportPacketPacket,
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.VesseloraclePacketData_ConsolidatedDataReportPacketPacket:
		err := im.keeper.OnAcknowledgementConsolidatedDataReportPacketPacket(ctx, modulePacket, *packet.ConsolidatedDataReportPacketPacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeConsolidatedDataReportPacketPacket
...
func (im IBCModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.VesseloraclePacketData_ConsolidatedDataReportPacketPacket:
		err := im.keeper.OnTimeoutConsolidatedDataReportPacketPacket(ctx, modulePacket, *packet.ConsolidatedDataReportPacketPacket)
		if err != nil {
			return err
		}
