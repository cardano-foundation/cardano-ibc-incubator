...
var (
	md_QueryLatestConsolidatedDataReportRequest     protoreflect.MessageDescriptor
	fd_QueryLatestConsolidatedDataReportRequest_imo protoreflect.FieldDescriptor
)

func init() {
	file_vesseloracle_vesseloracle_query_proto_init()
	md_QueryLatestConsolidatedDataReportRequest = File_vesseloracle_vesseloracle_query_proto.Messages().ByName("QueryLatestConsolidatedDataReportRequest")
	fd_QueryLatestConsolidatedDataReportRequest_imo = md_QueryLatestConsolidatedDataReportRequest.Fields().ByName("imo")
}

var _ protoreflect.Message = (*fastReflection_QueryLatestConsolidatedDataReportRequest)(nil)

type fastReflection_QueryLatestConsolidatedDataReportRequest QueryLatestConsolidatedDataReportRequest

func (x *QueryLatestConsolidatedDataReportRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryLatestConsolidatedDataReportRequest)(x)
}

func (x *QueryLatestConsolidatedDataReportRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryLatestConsolidatedDataReportRequest_messageType fastReflection_QueryLatestConsolidatedDataReportRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryLatestConsolidatedDataReportRequest_messageType{}

type fastReflection_QueryLatestConsolidatedDataReportRequest_messageType struct{}

func (x fastReflection_QueryLatestConsolidatedDataReportRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryLatestConsolidatedDataReportRequest)(nil)
}
func (x fastReflection_QueryLatestConsolidatedDataReportRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryLatestConsolidatedDataReportRequest)
}
func (x fastReflection_QueryLatestConsolidatedDataReportRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLatestConsolidatedDataReportRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLatestConsolidatedDataReportRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryLatestConsolidatedDataReportRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) New() protoreflect.Message {
	return new(fastReflection_QueryLatestConsolidatedDataReportRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryLatestConsolidatedDataReportRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Imo != "" {
		value := protoreflect.ValueOfString(x.Imo)
		if !f(fd_QueryLatestConsolidatedDataReportRequest_imo, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest.imo":
		return x.Imo != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest"))
		}
		panic(fmt.Errorf("message vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest.imo":
		x.Imo = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest.imo":
		value := x.Imo
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest.imo":
		x.Imo = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest.imo":
		panic(fmt.Errorf("field imo of message vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest.imo":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryLatestConsolidatedDataReportRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryLatestConsolidatedDataReportRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLatestConsolidatedDataReportRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLatestConsolidatedDataReportRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_QueryLatestConsolidatedDataReportResponse                        protoreflect.MessageDescriptor
	fd_QueryLatestConsolidatedDataReportResponse_consolidatedDataReport protoreflect.FieldDescriptor
)

func init() {
	file_vesseloracle_vesseloracle_query_proto_init()
	md_QueryLatestConsolidatedDataReportResponse = File_vesseloracle_vesseloracle_query_proto.Messages().ByName("QueryLatestConsolidatedDataReportResponse")
	fd_QueryLatestConsolidatedDataReportResponse_consolidatedDataReport = md_QueryLatestConsolidatedDataReportResponse.Fields().ByName("consolidatedDataReport")
}

var _ protoreflect.Message = (*fastReflection_QueryLatestConsolidatedDataReportResponse)(nil)

type fastReflection_QueryLatestConsolidatedDataReportResponse QueryLatestConsolidatedDataReportResponse

func (x *QueryLatestConsolidatedDataReportResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryLatestConsolidatedDataReportResponse)(x)
}

func (x *QueryLatestConsolidatedDataReportResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryLatestConsolidatedDataReportResponse_messageType fastReflection_QueryLatestConsolidatedDataReportResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryLatestConsolidatedDataReportResponse_messageType{}

type fastReflection_QueryLatestConsolidatedDataReportResponse_messageType struct{}

func (x fastReflection_QueryLatestConsolidatedDataReportResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryLatestConsolidatedDataReportResponse)(nil)
}
func (x fastReflection_QueryLatestConsolidatedDataReportResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryLatestConsolidatedDataReportResponse)
}
func (x fastReflection_QueryLatestConsolidatedDataReportResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLatestConsolidatedDataReportResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryLatestConsolidatedDataReportResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryLatestConsolidatedDataReportResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) New() protoreflect.Message {
	return new(fastReflection_QueryLatestConsolidatedDataReportResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryLatestConsolidatedDataReportResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ConsolidatedDataReport != nil {
		value := protoreflect.ValueOfMessage(x.ConsolidatedDataReport.ProtoReflect())
		if !f(fd_QueryLatestConsolidatedDataReportResponse_consolidatedDataReport, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport":
		return x.ConsolidatedDataReport != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse"))
		}
		panic(fmt.Errorf("message vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport":
		x.ConsolidatedDataReport = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport":
		value := x.ConsolidatedDataReport
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		...
		panic(fmt.Errorf("message vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport":
		x.ConsolidatedDataReport = value.Message().Interface().(*ConsolidatedDataReport)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport":
		if x.ConsolidatedDataReport == nil {
			x.ConsolidatedDataReport = new(ConsolidatedDataReport)
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport":
		m := new(ConsolidatedDataReport)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryLatestConsolidatedDataReportResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryLatestConsolidatedDataReportResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLatestConsolidatedDataReportResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryLatestConsolidatedDataReportResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *QueryAllConsolidatedDataReportRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_vesseloracle_vesseloracle_query_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *QueryAllConsolidatedDataReportResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_vesseloracle_vesseloracle_query_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *QueryLatestConsolidatedDataReportRequest) Reset() {
	*x = QueryLatestConsolidatedDataReportRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vesseloracle_vesseloracle_query_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryLatestConsolidatedDataReportRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryLatestConsolidatedDataReportRequest) ProtoMessage() {}

// Deprecated: Use QueryLatestConsolidatedDataReportRequest.ProtoReflect.Descriptor instead.
...
func (x *QueryLatestConsolidatedDataReportRequest) GetImo() string {
	if x != nil {
		return x.Imo
	}
	return ""
...
func (x *QueryLatestConsolidatedDataReportResponse) Reset() {
	*x = QueryLatestConsolidatedDataReportResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vesseloracle_vesseloracle_query_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryLatestConsolidatedDataReportResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryLatestConsolidatedDataReportResponse) ProtoMessage() {}

// Deprecated: Use QueryLatestConsolidatedDataReportResponse.ProtoReflect.Descriptor instead.
...
func (x *QueryLatestConsolidatedDataReportResponse) GetConsolidatedDataReport() *ConsolidatedDataReport {
	if x != nil {
		return x.ConsolidatedDataReport
	}
	return nil
...
func (*QueryAllConsolidatedDataReportRequest) Descriptor() ([]byte, []int) {
	return file_vesseloracle_vesseloracle_query_proto_rawDescGZIP(), []int{10}
}
...
func (*QueryAllConsolidatedDataReportResponse) Descriptor() ([]byte, []int) {
	return file_vesseloracle_vesseloracle_query_proto_rawDescGZIP(), []int{11}
}
...
var file_vesseloracle_vesseloracle_query_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x3c, 0x0a,
	0x28, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x73,
	0x6f, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x6d, 0x6f,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x69, 0x6d, 0x6f, 0x22, 0x9c, 0x01, 0x0a, 0x29,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x73, 0x6f,
	...
	0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x76, 0x65, 0x73, 0x73,
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x6f, 0x0a, 0x25, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x43, 0x6f, 0x6e, 0x73, 0x6f, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x32, 0x8f, 0x09, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x8e, 0x01, 0x0a, 0x06, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x2d, 0x2e, 0x76, 0x65, 0x73, 0x73, 0x65, 0x6c, 0x6f, 0x72,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x76, 0x65, 0x73, 0x73, 0x65, 0x6c, 0x6f, 0x72, 0x61,
	...
	0x6e, 0x74, 0x72, 0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2f, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0xa8, 0x01, 0x0a, 0x06,
	...
	,
	...
	,
...
var file_vesseloracle_vesseloracle_query_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_vesseloracle_vesseloracle_query_proto_goTypes = []interface{}{
	...
	(*QueryLatestConsolidatedDataReportRequest)(nil),  // 8: vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest
	(*QueryLatestConsolidatedDataReportResponse)(nil), // 9: vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse
	(*QueryAllConsolidatedDataReportRequest)(nil),     // 10: vesseloracle.vesseloracle.QueryAllConsolidatedDataReportRequest
	(*QueryAllConsolidatedDataReportResponse)(nil),    // 11: vesseloracle.vesseloracle.QueryAllConsolidatedDataReportResponse
	(*Params)(nil),                 // 12: vesseloracle.vesseloracle.Params
	(*Vessel)(nil),                 // 13: vesseloracle.vesseloracle.Vessel
	...
	(*ConsolidatedDataReport)(nil), // 16: vesseloracle.vesseloracle.ConsolidatedDataReport
}
var file_vesseloracle_vesseloracle_query_proto_depIdxs = []int32{
	12, // 0: vesseloracle.vesseloracle.QueryParamsResponse.params:type_name -> vesseloracle.vesseloracle.Params
	13, // 1: vesseloracle.vesseloracle.QueryGetVesselResponse.vessel:type_name -> vesseloracle.vesseloracle.Vessel
	14, // 2: vesseloracle.vesseloracle.QueryAllVesselRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	13, // 3: vesseloracle.vesseloracle.QueryAllVesselResponse.vessel:type_name -> vesseloracle.vesseloracle.Vessel
	15, // 4: vesseloracle.vesseloracle.QueryAllVesselResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	16, // 5: vesseloracle.vesseloracle.QueryGetConsolidatedDataReportResponse.consolidatedDataReport:type_name -> vesseloracle.vesseloracle.ConsolidatedDataReport
	16, // 6: vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse.consolidatedDataReport:type_name -> vesseloracle.vesseloracle.ConsolidatedDataReport
	14, // 7: vesseloracle.vesseloracle.QueryAllConsolidatedDataReportRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	16, // 8: vesseloracle.vesseloracle.QueryAllConsolidatedDataReportResponse.consolidatedDataReport:type_name -> vesseloracle.vesseloracle.ConsolidatedDataReport
	15, // 9: vesseloracle.vesseloracle.QueryAllConsolidatedDataReportResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	0,  // 10: vesseloracle.vesseloracle.Query.Params:input_type -> vesseloracle.vesseloracle.QueryParamsRequest
	2,  // 11: vesseloracle.vesseloracle.Query.Vessel:input_type -> vesseloracle.vesseloracle.QueryGetVesselRequest
	4,  // 12: vesseloracle.vesseloracle.Query.VesselAll:input_type -> vesseloracle.vesseloracle.QueryAllVesselRequest
	6,  // 13: vesseloracle.vesseloracle.Query.ConsolidatedDataReport:input_type -> vesseloracle.vesseloracle.QueryGetConsolidatedDataReportRequest
	8,  // 14: vesseloracle.vesseloracle.Query.LatestConsolidatedDataReport:input_type -> vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportRequest
	10, // 15: vesseloracle.vesseloracle.Query.ConsolidatedDataReportAll:input_type -> vesseloracle.vesseloracle.QueryAllConsolidatedDataReportRequest
	1,  // 16: vesseloracle.vesseloracle.Query.Params:output_type -> vesseloracle.vesseloracle.QueryParamsResponse
	3,  // 17: vesseloracle.vesseloracle.Query.Vessel:output_type -> vesseloracle.vesseloracle.QueryGetVesselResponse
	5,  // 18: vesseloracle.vesseloracle.Query.VesselAll:output_type -> vesseloracle.vesseloracle.QueryAllVesselResponse
	7,  // 19: vesseloracle.vesseloracle.Query.ConsolidatedDataReport:output_type -> vesseloracle.vesseloracle.QueryGetConsolidatedDataReportResponse
	9,  // 20: vesseloracle.vesseloracle.Query.LatestConsolidatedDataReport:output_type -> vesseloracle.vesseloracle.QueryLatestConsolidatedDataReportResponse
	11, // 21: vesseloracle.vesseloracle.Query.ConsolidatedDataReportAll:output_type -> vesseloracle.vesseloracle.QueryAllConsolidatedDataReportResponse
...
func file_vesseloracle_vesseloracle_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vesseloracle_vesseloracle_query_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryLatestConsolidatedDataReportRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vesseloracle_vesseloracle_query_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryLatestConsolidatedDataReportResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_vesseloracle_vesseloracle_query_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_vesseloracle_vesseloracle_query_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
