module github.com/cardano-foundation/cardano-ibc-incubator/cosmos/cardano-entrypoint/datasource

go 1.24.0

replace cardano-entrypoint => ..

require (
	cardano-entrypoint v0.0.0-00010101000000-000000000000
