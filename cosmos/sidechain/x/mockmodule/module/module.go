...
import (
	...
	modulev1 "sidechain/api/sidechain/mockmodule/module"
	"sidechain/x/mockmodule/client/cli"
...
type ModuleOutputs struct {
	...
	MockmoduleKeeper keeper.Keeper
...
func ProvideModule(in ModuleInputs) ModuleOutputs {
	...
	return ModuleOutputs{MockmoduleKeeper: k, Module: m}
}
