...
// func (suite *CardanoTestSuite) TestCheckSubstituteUpdateStateBasic() {
// 	var (
...
// func (suite *CardanoTestSuite) TestCheckSubstituteAndUpdateState() {
// 	testCases := []struct {
// 		name         string
// 		FreezeClient bool
// 		expPass      bool
...
// func (suite *CardanoTestSuite) TestIsMatchingClientState() {
// 	var (
