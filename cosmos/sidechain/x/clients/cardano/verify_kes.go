...
type SumXKesSig struct {
	Depth uint64
	Sigma interface{}
	LhsPk ed25519.PublicKey
	RhsPk ed25519.PublicKey
}
...
func VerifyKes(header *ledger.BabbageBlockHeader, spkp uint64) (bool, error) {
	...
	currentKesPeriod := currentSlot / spkp
	t := uint64(0)
