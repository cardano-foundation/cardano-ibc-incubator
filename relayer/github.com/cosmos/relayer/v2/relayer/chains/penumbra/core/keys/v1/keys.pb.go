...
type PositionMetadataKey struct {
	Inner []byte `protobuf:"bytes,1,opt,name=inner,proto3" json:"inner,omitempty"`
}

func (m *PositionMetadataKey) Reset()         { *m = PositionMetadataKey{} }
func (m *PositionMetadataKey) String() string { return proto.CompactTextString(m) }
func (*PositionMetadataKey) ProtoMessage()    {}
func (*PositionMetadataKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_171d3f5d66e6613e, []int{11}
}
func (m *PositionMetadataKey) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PositionMetadataKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PositionMetadataKey.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PositionMetadataKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PositionMetadataKey.Merge(m, src)
}
func (m *PositionMetadataKey) XXX_Size() int {
	return m.Size()
}
func (m *PositionMetadataKey) XXX_DiscardUnknown() {
	xxx_messageInfo_PositionMetadataKey.DiscardUnknown(m)
}

var xxx_messageInfo_PositionMetadataKey proto.InternalMessageInfo

func (m *PositionMetadataKey) GetInner() []byte {
	if m != nil {
		return m.Inner
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PositionMetadataKey)(nil), "penumbra.core.keys.v1.PositionMetadataKey")
}
...
var fileDescriptor_171d3f5d66e6613e = []byte{
	...
	,
}
...
func (m *PositionMetadataKey) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PositionMetadataKey) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionMetadataKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PositionMetadataKey) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PositionMetadataKey) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PositionMetadataKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PositionMetadataKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
