...
type PositionMetadata struct {
	...
	Strategy uint32 `protobuf:"fixed32,1,opt,name=strategy,proto3" json:"strategy,omitempty"`
	// A unique identifier for the bundle this position belongs to.
	Identifier uint32 `protobuf:"fixed32,2,opt,name=identifier,proto3" json:"identifier,omitempty"`
}
...
func (m *PositionMetadata) GetStrategy() uint32 {
	if m != nil {
		return m.Strategy
	}
	return 0
...
func (m *PositionMetadata) GetIdentifier() uint32 {
	if m != nil {
		return m.Identifier
	}
	return 0
...
func (m *PositionOpen) GetEncryptedMetadata() []byte {
	if m != nil {
...
type PositionOpenPlan struct {
	Position *Position         `protobuf:"bytes,1,opt,name=position,proto3" json:"position,omitempty"`
	Metadata *PositionMetadata `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
}

func (m *PositionOpenPlan) Reset()         { *m = PositionOpenPlan{} }
func (m *PositionOpenPlan) String() string { return proto.CompactTextString(m) }
func (*PositionOpenPlan) ProtoMessage()    {}
func (*PositionOpenPlan) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{24}
}
func (m *PositionOpenPlan) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PositionOpenPlan) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PositionOpenPlan.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PositionOpenPlan) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PositionOpenPlan.Merge(m, src)
}
func (m *PositionOpenPlan) XXX_Size() int {
	return m.Size()
}
func (m *PositionOpenPlan) XXX_DiscardUnknown() {
	xxx_messageInfo_PositionOpenPlan.DiscardUnknown(m)
}

var xxx_messageInfo_PositionOpenPlan proto.InternalMessageInfo

func (m *PositionOpenPlan) GetPosition() *Position {
	if m != nil {
		return m.Position
	}
	return nil
...
func (m *PositionOpenPlan) GetMetadata() *PositionMetadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
type PositionOpenView struct {
	// Types that are valid to be assigned to PositionOpenView:
	//
	//	*PositionOpenView_Visible_
	//	*PositionOpenView_Opaque_
	PositionOpenView isPositionOpenView_PositionOpenView `protobuf_oneof:"position_open_view"`
}

func (m *PositionOpenView) Reset()         { *m = PositionOpenView{} }
func (m *PositionOpenView) String() string { return proto.CompactTextString(m) }
func (*PositionOpenView) ProtoMessage()    {}
func (*PositionOpenView) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{25}
}
func (m *PositionOpenView) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PositionOpenView) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PositionOpenView.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PositionOpenView) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PositionOpenView.Merge(m, src)
}
func (m *PositionOpenView) XXX_Size() int {
	return m.Size()
}
func (m *PositionOpenView) XXX_DiscardUnknown() {
	xxx_messageInfo_PositionOpenView.DiscardUnknown(m)
}

var xxx_messageInfo_PositionOpenView proto.InternalMessageInfo

type isPositionOpenView_PositionOpenView interface {
	isPositionOpenView_PositionOpenView()
	MarshalTo([]byte) (int, error)
	Size() int
}

type PositionOpenView_Visible_ struct {
	Visible *PositionOpenView_Visible `protobuf:"bytes,1,opt,name=visible,proto3,oneof" json:"visible,omitempty"`
}
type PositionOpenView_Opaque_ struct {
	Opaque *PositionOpenView_Opaque `protobuf:"bytes,2,opt,name=opaque,proto3,oneof" json:"opaque,omitempty"`
}

func (*PositionOpenView_Visible_) isPositionOpenView_PositionOpenView() {}
func (*PositionOpenView_Opaque_) isPositionOpenView_PositionOpenView()  {}

func (m *PositionOpenView) GetPositionOpenView() isPositionOpenView_PositionOpenView {
	if m != nil {
		return m.PositionOpenView
	}
	return nil
}

func (m *PositionOpenView) GetVisible() *PositionOpenView_Visible {
	if x, ok := m.GetPositionOpenView().(*PositionOpenView_Visible_); ok {
		return x.Visible
	}
	return nil
}

func (m *PositionOpenView) GetOpaque() *PositionOpenView_Opaque {
	if x, ok := m.GetPositionOpenView().(*PositionOpenView_Opaque_); ok {
		return x.Opaque
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*PositionOpenView) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PositionOpenView_Visible_)(nil),
		(*PositionOpenView_Opaque_)(nil),
	}
}

type PositionOpenView_Visible struct {
	Action   *PositionOpen     `protobuf:"bytes,1,opt,name=action,proto3" json:"action,omitempty"`
	Metadata *PositionMetadata `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
}

func (m *PositionOpenView_Visible) Reset()         { *m = PositionOpenView_Visible{} }
func (m *PositionOpenView_Visible) String() string { return proto.CompactTextString(m) }
func (*PositionOpenView_Visible) ProtoMessage()    {}
func (*PositionOpenView_Visible) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{25, 0}
}
func (m *PositionOpenView_Visible) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PositionOpenView_Visible) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PositionOpenView_Visible.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PositionOpenView_Visible) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PositionOpenView_Visible.Merge(m, src)
}
func (m *PositionOpenView_Visible) XXX_Size() int {
	return m.Size()
}
func (m *PositionOpenView_Visible) XXX_DiscardUnknown() {
	xxx_messageInfo_PositionOpenView_Visible.DiscardUnknown(m)
}

var xxx_messageInfo_PositionOpenView_Visible proto.InternalMessageInfo

func (m *PositionOpenView_Visible) GetAction() *PositionOpen {
	if m != nil {
		return m.Action
	}
	return nil
...
func (m *PositionOpenView_Visible) GetMetadata() *PositionMetadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
type PositionOpenView_Opaque struct {
	Action *PositionOpen `protobuf:"bytes,1,opt,name=action,proto3" json:"action,omitempty"`
}

func (m *PositionOpenView_Opaque) Reset()         { *m = PositionOpenView_Opaque{} }
func (m *PositionOpenView_Opaque) String() string { return proto.CompactTextString(m) }
func (*PositionOpenView_Opaque) ProtoMessage()    {}
func (*PositionOpenView_Opaque) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{25, 1}
}
func (m *PositionOpenView_Opaque) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PositionOpenView_Opaque) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PositionOpenView_Opaque.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PositionOpenView_Opaque) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PositionOpenView_Opaque.Merge(m, src)
}
func (m *PositionOpenView_Opaque) XXX_Size() int {
	return m.Size()
}
func (m *PositionOpenView_Opaque) XXX_DiscardUnknown() {
	xxx_messageInfo_PositionOpenView_Opaque.DiscardUnknown(m)
}

var xxx_messageInfo_PositionOpenView_Opaque proto.InternalMessageInfo

func (m *PositionOpenView_Opaque) GetAction() *PositionOpen {
	if m != nil {
		return m.Action
	}
	return nil
...
func (*SwapExecution_Trace) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{29, 0}
}
...
func (*SimulateTradeRequest_Routing) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{52, 0}
}
...
func (*SimulateTradeRequest_Routing_SingleHop) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{52, 0, 0}
}
...
func (*SimulateTradeRequest_Routing_Default) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{52, 0, 1}
}
...
// the position.
type EventLqtPositionVolume struct {
	...
	AssetId *v14.AssetId `protobuf:"bytes,2,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`
	// The position ID.
	PositionId *PositionId `protobuf:"bytes,3,opt,name=position_id,json=positionId,proto3" json:"position_id,omitempty"`
	// The volume amount.
	VolumeAmount *v13.Amount `protobuf:"bytes,4,opt,name=volume_amount,json=volumeAmount,proto3" json:"volume_amount,omitempty"`
	// The total volume for the pair thus far.
	TotalVolume *v13.Amount `protobuf:"bytes,5,opt,name=total_volume,json=totalVolume,proto3" json:"total_volume,omitempty"`
	// The amount of staking token flowing in (possibly 0).
	StakingTokenIn *v13.Amount `protobuf:"bytes,6,opt,name=staking_token_in,json=stakingTokenIn,proto3" json:"staking_token_in,omitempty"`
	// The amount of the other asset flowing in (possibly 0).
	AssetIn *v13.Amount `protobuf:"bytes,7,opt,name=asset_in,json=assetIn,proto3" json:"asset_in,omitempty"`
	// The amount of fees we've just received in the staking token.
	StakingFees *v13.Amount `protobuf:"bytes,8,opt,name=staking_fees,json=stakingFees,proto3" json:"staking_fees,omitempty"`
	// The amount of fees we've just received in the particular asset.
	AssetFees *v13.Amount `protobuf:"bytes,9,opt,name=asset_fees,json=assetFees,proto3" json:"asset_fees,omitempty"`
}

func (m *EventLqtPositionVolume) Reset()         { *m = EventLqtPositionVolume{} }
func (m *EventLqtPositionVolume) String() string { return proto.CompactTextString(m) }
func (*EventLqtPositionVolume) ProtoMessage()    {}
func (*EventLqtPositionVolume) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{55}
}
func (m *EventLqtPositionVolume) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventLqtPositionVolume) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventLqtPositionVolume.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventLqtPositionVolume) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventLqtPositionVolume.Merge(m, src)
}
func (m *EventLqtPositionVolume) XXX_Size() int {
	return m.Size()
}
func (m *EventLqtPositionVolume) XXX_DiscardUnknown() {
	xxx_messageInfo_EventLqtPositionVolume.DiscardUnknown(m)
}

var xxx_messageInfo_EventLqtPositionVolume proto.InternalMessageInfo

func (m *EventLqtPositionVolume) GetEpochIndex() uint64 {
	if m != nil {
		return m.EpochIndex
	}
	return 0
...
func (m *EventLqtPositionVolume) GetAssetId() *v14.AssetId {
	if m != nil {
		return m.AssetId
	}
	return nil
...
func (m *EventLqtPositionVolume) GetPositionId() *PositionId {
	if m != nil {
		return m.PositionId
	}
	return nil
...
func (m *EventLqtPositionVolume) GetVolumeAmount() *v13.Amount {
	if m != nil {
		return m.VolumeAmount
	}
	return nil
}

func (m *EventLqtPositionVolume) GetTotalVolume() *v13.Amount {
	if m != nil {
...
func (m *EventLqtPositionVolume) GetStakingTokenIn() *v13.Amount {
	if m != nil {
		return m.StakingTokenIn
	}
	return nil
}

func (m *EventLqtPositionVolume) GetAssetIn() *v13.Amount {
	if m != nil {
		return m.AssetIn
	}
	return nil
...
func (m *EventLqtPositionVolume) GetStakingFees() *v13.Amount {
	if m != nil {
		return m.StakingFees
	}
	return nil
}

func (m *EventLqtPositionVolume) GetAssetFees() *v13.Amount {
	if m != nil {
		return m.AssetFees
	}
	return nil
...
func (*CandlestickDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{70}
}
...
func (*CandlestickDataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{71}
}
...
func (*CandlestickDataStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{72}
}
...
func (*CandlestickDataStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec17dcdac15b4004, []int{73}
}
...
func init() {
	...
	proto.RegisterType((*PositionMetadata)(nil), "penumbra.core.component.dex.v1.PositionMetadata")
	proto.RegisterType((*PositionOpen)(nil), "penumbra.core.component.dex.v1.PositionOpen")
	proto.RegisterType((*PositionOpenPlan)(nil), "penumbra.core.component.dex.v1.PositionOpenPlan")
	proto.RegisterType((*PositionOpenView)(nil), "penumbra.core.component.dex.v1.PositionOpenView")
	proto.RegisterType((*PositionOpenView_Visible)(nil), "penumbra.core.component.dex.v1.PositionOpenView.Visible")
	proto.RegisterType((*PositionOpenView_Opaque)(nil), "penumbra.core.component.dex.v1.PositionOpenView.Opaque")
	...
	proto.RegisterType((*EventLqtPositionVolume)(nil), "penumbra.core.component.dex.v1.EventLqtPositionVolume")
...
var fileDescriptor_ec17dcdac15b4004 = []byte{
	...
	,
}
...
func (m *PositionMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Identifier != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(m.Identifier))
		i--
		dAtA[i] = 0x15
	}
	if m.Strategy != 0 {
		i -= 4
		encoding_binary.LittleEndian.PutUint32(dAtA[i:], uint32(m.Strategy))
		i--
		dAtA[i] = 0xd
	}
	return len(dAtA) - i, nil
...
func (m *PositionOpen) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.EncryptedMetadata) > 0 {
		i -= len(m.EncryptedMetadata)
		copy(dAtA[i:], m.EncryptedMetadata)
		i = encodeVarintDex(dAtA, i, uint64(len(m.EncryptedMetadata)))
		i--
		dAtA[i] = 0x12
	}
	if m.Position != nil {
...
func (m *PositionOpenPlan) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PositionOpenPlan) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionOpenPlan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PositionOpenView) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PositionOpenView) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionOpenView) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.PositionOpenView != nil {
		{
			size := m.PositionOpenView.Size()
			i -= size
			if _, err := m.PositionOpenView.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *PositionOpenView_Visible_) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionOpenView_Visible_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Visible != nil {
		{
			size, err := m.Visible.MarshalToSizedBuffer(dAtA[:i])
...
func (m *PositionOpenView_Opaque_) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionOpenView_Opaque_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Opaque != nil {
		{
			size, err := m.Opaque.MarshalToSizedBuffer(dAtA[:i])
...
func (m *PositionOpenView_Visible) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PositionOpenView_Visible) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionOpenView_Visible) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PositionOpenView_Opaque) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PositionOpenView_Opaque) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PositionOpenView_Opaque) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventLqtPositionVolume) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventLqtPositionVolume) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventLqtPositionVolume) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.AssetFees != nil {
		{
			size, err := m.AssetFees.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.StakingFees != nil {
		{
			size, err := m.StakingFees.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.AssetIn != nil {
		{
			size, err := m.AssetIn.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.StakingTokenIn != nil {
		{
			size, err := m.StakingTokenIn.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.TotalVolume != nil {
		{
			size, err := m.TotalVolume.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.VolumeAmount != nil {
		{
			size, err := m.VolumeAmount.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.EpochIndex != 0 {
		i = encodeVarintDex(dAtA, i, uint64(m.EpochIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PositionOpenPlan) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PositionOpenView) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.PositionOpenView != nil {
		n += m.PositionOpenView.Size()
	}
	return n
}

func (m *PositionOpenView_Visible_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PositionOpenView_Opaque_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PositionOpenView_Visible) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PositionOpenView_Opaque) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventLqtPositionVolume) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EpochIndex != 0 {
		n += 1 + sovDex(uint64(m.EpochIndex))
	}
	if m.AssetId != nil {
		l = m.AssetId.Size()
		n += 1 + l + sovDex(uint64(l))
...
func (m *PositionMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Strategy = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
		case 2:
			if wireType != 5 {
			...
			m.Identifier = uint32(encoding_binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
		default:
			iNdEx = preIndex
			skippy, err := skipDex(dAtA[iNdEx:])
...
func (m *PositionOpen) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptedMetadata", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncryptedMetadata = append(m.EncryptedMetadata[:0], dAtA[iNdEx:postIndex]...)
			if m.EncryptedMetadata == nil {
				m.EncryptedMetadata = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *PositionOpenPlan) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PositionOpenPlan: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PositionOpenPlan: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PositionOpenView) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PositionOpenView: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PositionOpenView: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			v := &PositionOpenView_Visible{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.PositionOpenView = &PositionOpenView_Visible_{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Opaque", wireType)
			...
			v := &PositionOpenView_Opaque{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.PositionOpenView = &PositionOpenView_Opaque_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDex(dAtA[iNdEx:])
...
func (m *PositionOpenView_Visible) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *PositionOpenView_Opaque) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *EventLqtPositionVolume) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventLqtPositionVolume: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventLqtPositionVolume: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VolumeAmount", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VolumeAmount == nil {
				m.VolumeAmount = &v13.Amount{}
			}
			if err := m.VolumeAmount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StakingTokenIn", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StakingTokenIn == nil {
				m.StakingTokenIn = &v13.Amount{}
			}
			if err := m.StakingTokenIn.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			...
			if m.AssetIn == nil {
				m.AssetIn = &v13.Amount{}
			}
			if err := m.AssetIn.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StakingFees", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StakingFees == nil {
				m.StakingFees = &v13.Amount{}
			}
			if err := m.StakingFees.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AssetFees", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AssetFees == nil {
				m.AssetFees = &v13.Amount{}
			}
			if err := m.AssetFees.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
