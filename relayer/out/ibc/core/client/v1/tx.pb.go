...
func (x *MsgCreateClient) GetClientState() *any.Any {
	if x != nil {
...
func (x *MsgCreateClient) GetConsensusState() *any.Any {
	if x != nil {
...
type MsgCreateClientResponse struct {
	...
	UnsignedTx *any.Any `protobuf:"bytes,1,opt,name=unsigned_tx,json=unsignedTx,proto3" json:"unsigned_tx,omitempty"`
...
func (x *MsgCreateClientResponse) GetUnsignedTx() *any.Any {
	if x != nil {
		return x.UnsignedTx
	}
	return nil
...
func (x *MsgUpdateClient) GetClientMessage() *any.Any {
	if x != nil {
...
func (x *MsgUpdateClientResponse) GetUnsignedTx() *any.Any {
	if x != nil {
		return x.UnsignedTx
	}
	return nil
...
func (x *MsgUpgradeClient) GetClientState() *any.Any {
	if x != nil {
		return x.ClientState
	}
	return nil
...
func (x *MsgUpgradeClient) GetConsensusState() *any.Any {
	if x != nil {
		return x.ConsensusState
	}
	return nil
...
// Deprecated: Do not use.
func (x *MsgSubmitMisbehaviour) GetMisbehaviour() *any.Any {
	if x != nil {
...
var file_ibc_core_client_v1_tx_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x3a, 0x08, 0xe8, 0xa0, 0x1f,
	0x00, 0x88, 0xa0, 0x1f, 0x00, 0x22, 0x6d, 0x0a, 0x17, 0x4d, 0x73, 0x67, 0x43, 0x72, 0x65, 0x61,
	...
	0x3a, 0x08, 0xe8, 0xa0, 0x1f, 0x00, 0x88, 0xa0, 0x1f, 0x00, 0x22, 0x50, 0x0a, 0x17, 0x4d, 0x73,
	...
	0x09, 0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x3a, 0x08, 0xe8, 0xa0, 0x1f, 0x00, 0x88,
	...
	0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x3a, 0x08, 0xe8, 0xa0, 0x1f, 0x00, 0x88, 0xa0,
