...
func (cc *CardanoProvider) LogFailedTx(res *provider.RelayerTxResponse, err error, msgs []provider.RelayerMessage) {
...
func (cc *CardanoProvider) LogSuccessTx(res *sdk.TxResponse, msgs []provider.RelayerMessage) {
	// Include the chain_id
	fields := []zapcore.Field{zap.String("chain_id", cc.ChainId())}
