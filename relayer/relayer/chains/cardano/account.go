...
var _ client.AccountRetriever = &CardanoProvider{}

// GetAccount queries for an account given an address and a block height. An
// error is returned if the query or decoding fails.
func (cc *CardanoProvider) GetAccount(clientCtx client.Context, addr sdk.AccAddress) (client.Account, error) {
...
// or decoding fails.
func (cc *CardanoProvider) GetAccountWithHeight(clientCtx client.Context, addr sdk.AccAddress) (client.Account, int64, error) {
...
func (cc *CardanoProvider) EnsureExists(clientCtx client.Context, addr sdk.AccAddress) error {
...
func (cc *CardanoProvider) GetAccountNumberSequence(clientCtx client.Context, addr sdk.AccAddress) (uint64, uint64, error) {
