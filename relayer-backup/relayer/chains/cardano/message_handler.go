...
func (ccp *CardanoChainProcessor) handleMessage(ctx context.Context, m ibcMessage, c processor.IBCMessagesCache) {
...
func (ccp *CardanoChainProcessor) handlePacketMessage(eventType string, pi provider.PacketInfo, c processor.IBCMessagesCache) {
...
func (ccp *CardanoChainProcessor) handleChannelMessage(eventType string, ci provider.ChannelInfo, ibcMessagesCache processor.IBCMessagesCache) {
...
func (ccp *CardanoChainProcessor) logChannelOpenMessage(message string, ci provider.ChannelInfo) {
	fields := []zap.Field{
...
func (ccp *CardanoChainProcessor) logChannelMessage(message string, ci provider.ChannelInfo) {
...
func (ccp *CardanoChainProcessor) handleConnectionMessage(eventType string, ci provider.ConnectionInfo, ibcMessagesCache processor.IBCMessagesCache) {
...
func (ccp *CardanoChainProcessor) logObservedIBCMessage(m string, fields ...zap.Field) {
	ccp.log.With(zap.String("event_type", m)).Debug("Observed IBC message", fields...)
}

func (ccp *CardanoChainProcessor) logPacketMessage(message string, pi provider.PacketInfo) {
