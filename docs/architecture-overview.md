...
This page is the index for architecture diagrams in this repository.

## Diagram Locations

- System architecture diagram: `README.md` under `Architecture`
...
- [System Architecture Diagram](../README.md#architecture)
