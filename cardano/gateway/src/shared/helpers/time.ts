...
const queryNetworkBlockHeight = async (ogmiosUrl: string): Promise<number> => {
  return ogmiosRequest<number>(ogmiosUrl, 'queryNetwork/blockHeight', {});
};
...
const queryTransactionInclusionBlockHeight = async (
  ...
  return new Promise<number>((resolve, reject) => {
    ...
    client.once('close', (_code, _reason) => {
      if (!settled) {
...
export { querySystemStart, queryNetworkTipPoint, queryNetworkBlockHeight, queryTransactionInclusionBlockHeight, sleep, getNanoseconds };
