...
export type VerifyProofRedeemer =
  ...
  | {
      BatchVerifyMembershipAndNonMembership: {
        memberships: VerifyMembershipParams[];
        non_memberships: VerifyNonMembershipParams[];
      };
    };
...
export function encodeVerifyProofRedeemer(
  ...
  const VerifyNonMembershipParamsSchema = Data.Object({
    cs: ClientStateSchema,
    cons_state: ConsensusStateSchema,
    height: HeightSchema,
    processed_time: Data.Integer(),
  ...
  const VerifyProofRedeemerSchema = Data.Enum([
    ...
    Data.Object({
      BatchVerifyMembershipAndNonMembership: Data.Object({
        memberships: Data.Array(VerifyMembershipParamsSchema),
        non_memberships: Data.Array(VerifyNonMembershipParamsSchema),
      }),
    }),
  ]);
