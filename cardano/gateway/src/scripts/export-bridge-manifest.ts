...
import { deriveCardanoNetwork, normalizeLegacyDeploymentConfig } from '../config/bridge-manifest';
...
const loadedBridgeConfig = normalizeLegacyDeploymentConfig(handlerJson, {
