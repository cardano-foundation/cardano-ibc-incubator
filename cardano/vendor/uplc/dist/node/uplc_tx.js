 ...
 * @returns {Uint8Array[]}
 */
module.exports.eval_phase_two_raw = function(transaction, inputs, outputs, cost_models, cpu, memory, zero_time, zero_slot, slot_length) {
 ...
 * @returns {Uint8Array}
 */
module.exports.apply_params_to_script = function(parameters, script) {
