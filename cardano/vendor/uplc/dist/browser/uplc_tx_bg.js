 ...
 * @returns {Uint8Array[]}
 */
export function eval_phase_two_raw(transaction, inputs, outputs, cost_models, cpu, memory, zero_time, zero_slot, slot_length) {
    ...
    const ret = wasm.eval_phase_two_raw(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, cpu, memory, zero_time, zero_slot, slot_length);
    if (ret[3]) {
 ...
 * @returns {Uint8Array[]}
 */
export function eval_phase_two_raw_with_protocol(transaction, inputs, outputs, cost_models, cpu, memory, zero_time, zero_slot, slot_length, protocol_major_version) {
    const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(inputs, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function apply_params_to_script(parameters, script) {
    const ptr0 = passArray8ToWasm0(parameters, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(script, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
