...
export const LeafOp = {
  ...
  fromJSON(object: any): LeafOp {
    ...
    if (isSet(object.prehash_key)) obj.prehash_key = hashOpFromJSON(object.prehash_key);
    if (isSet(object.prehash_value)) obj.prehash_value = hashOpFromJSON(object.prehash_value);
...
export const ProofSpec = {
  ...
  fromJSON(object: any): ProofSpec {
    ...
    if (isSet(object.leaf_spec)) obj.leaf_spec = LeafOp.fromJSON(object.leaf_spec);
    if (isSet(object.inner_spec)) obj.inner_spec = InnerSpec.fromJSON(object.inner_spec);
    if (isSet(object.max_depth)) obj.max_depth = Number(object.max_depth);
    if (isSet(object.min_depth)) obj.min_depth = Number(object.min_depth);
    return obj;
  },
  toJSON(message: ProofSpec): unknown {
    const obj: any = {};
    message.leaf_spec !== undefined &&
      (obj.leaf_spec = message.leaf_spec ? LeafOp.toJSON(message.leaf_spec) : undefined);
    message.inner_spec !== undefined &&
      (obj.inner_spec = message.inner_spec ? InnerSpec.toJSON(message.inner_spec) : undefined);
...
export const InnerSpec = {
  ...
  fromJSON(object: any): InnerSpec {
    ...
    if (Array.isArray(object?.child_order)) obj.child_order = object.child_order.map((e: any) => Number(e));
    if (isSet(object.child_size)) obj.child_size = Number(object.child_size);
    if (isSet(object.min_prefix_length)) obj.min_prefix_length = Number(object.min_prefix_length);
    if (isSet(object.max_prefix_length)) obj.max_prefix_length = Number(object.max_prefix_length);
    if (isSet(object.empty_child)) obj.empty_child = bytesFromBase64(object.empty_child);
    if (isSet(object.hash)) obj.hash = hashOpFromJSON(object.hash);
    return obj;
  },
  toJSON(message: InnerSpec): unknown {
    ...
    message.empty_child !== undefined &&
      (obj.empty_child = base64FromBytes(
        message.empty_child !== undefined ? message.empty_child : new Uint8Array(),
      ));
    message.hash !== undefined && (obj.hash = hashOpToJSON(message.hash));
    return obj;
  },
...
export const CompressedBatchProof = {
  ...
  fromJSON(object: any): CompressedBatchProof {
    ...
    if (Array.isArray(object?.lookup_inners))
      obj.lookup_inners = object.lookup_inners.map((e: any) => InnerOp.fromJSON(e));
    return obj;
  },
