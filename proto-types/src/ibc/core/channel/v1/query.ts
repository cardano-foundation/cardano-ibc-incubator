...
export const QueryPacketAcknowledgementsRequest = {
  ...
  fromJSON(object: any): QueryPacketAcknowledgementsRequest {
    ...
    if (isSet(object.channel_id)) obj.channel_id = String(object.channel_id);
    if (isSet(object.pagination)) obj.pagination = PageRequest.fromJSON(object.pagination);
    if (Array.isArray(object?.packet_commitment_sequences)) obj.packet_commitment_sequences = object.packet_commitment_sequences.map((e: any) => BigInt(e.toString()));
    return obj;
  },
...
export const QueryUnreceivedAcksRequest = {
  ...
  fromJSON(object: any): QueryUnreceivedAcksRequest {
    ...
    if (isSet(object.port_id)) obj.port_id = String(object.port_id);
    if (isSet(object.channel_id)) obj.channel_id = String(object.channel_id);
    if (Array.isArray(object?.packet_ack_sequences)) obj.packet_ack_sequences = object.packet_ack_sequences.map((e: any) => BigInt(e.toString()));
    return obj;
  },
...
export const QueryNextSequenceReceiveResponse = {
  ...
  fromJSON(object: any): QueryNextSequenceReceiveResponse {
    ...
    if (isSet(object.next_sequence_receive)) obj.next_sequence_receive = BigInt(object.next_sequence_receive.toString());
    if (isSet(object.proof)) obj.proof = bytesFromBase64(object.proof);
    if (isSet(object.proof_height)) obj.proof_height = Height.fromJSON(object.proof_height);
    return obj;
  },
